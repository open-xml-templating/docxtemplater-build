  ...
  return parts.reduce(function (full, part) {
    for (var i = 0, len = contains.length; i < len; i++) {
      ...
      if (currentlyCollecting === i) {
        ...
        if (part.indexOf("<".concat(shouldContain, " ")) !== -1 || part.indexOf("<".concat(shouldContain, ">")) !== -1) {
          currentlyCollecting = -1;
...
},{"../doc-utils":2,"../module-wrapper":8,"../prefix-matcher":17}],12:[function(require,module,exports){
"use strict";
...
},{"../doc-utils":2,"../errors":3,"../module-wrapper":8,"../prefix-matcher":17,"../traits":21}],13:[function(require,module,exports){
"use strict";
...
function moduleParse(modules, placeHolderContent, parsed, startOffset, endLindex, options) {
  var moduleParsed;
    ...
    return lexed.reduce(function lexedToParsed(parsed, token) {
      if (token.type === "delimiter") {
        ...
        if (token.position === "end") {
          ...
          parsed = moduleParse(modules, placeHolderContent, parsed, startOffset, endLindex, options);
          startOffset = null;
...
var currentModuleApiVersion = [3, 16, 0];
