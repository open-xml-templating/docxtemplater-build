...
},{"../doc-utils":2,"../errors":3,"../mergesort":6,"../module-wrapper":7,"../traits":18}],9:[function(require,module,exports){
"use strict";
...
},{"../doc-utils":2,"../module-wrapper":7}],10:[function(require,module,exports){
"use strict";
...
},{"../doc-utils":2,"../errors":3,"../module-wrapper":7,"../traits":18}],11:[function(require,module,exports){
"use strict";
...
},{"./doc-utils":2,"./errors":3}],16:[function(require,module,exports){
"use strict";
	...
	return Promise.all(compiled.map(function (part) {
		...
		if (moduleResolved) {
			return moduleResolved.then(function (value) {
				resolved.push({ tag: part.value, value: value, lIndex: part.lIndex });
			});
		}
...
},{"./errors":3}],18:[function(require,module,exports){
"use strict";
...
},{"./doc-utils":2}],20:[function(require,module,exports){
"use strict";
		...
		value: function resolveTags(tags) {
			...
			return resolve(options).then(function (_ref) {
				...
				return Promise.all(resolved.map(function (r) {
					...
					_this.setModules({ inspect: { resolved: resolved } });
...
},{"./doc-utils":2,"./errors":3,"./lexer":5,"./parser.js":13,"./postrender.js":14,"./render.js":15,"./resolve.js":16,"./scope-manager":17,"./xml-matcher":19}],"/src/js/docxtemplater.js":[function(require,module,exports){
"use strict";
...
},{"./doc-utils":2,"./errors":3,"./file-type-config":4,"./module-wrapper":7,"./traits":18,"./xml-matcher":19,"./xml-templater":20}]},{},[])("/src/js/docxtemplater.js")
});
