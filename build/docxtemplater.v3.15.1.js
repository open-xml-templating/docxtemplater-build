...
function moduleParse(placeHolderContent, modules, startOffset, endLindex, options) {
  var moduleParsed;
      ...
      if (token.type === "delimiter") {
        ...
        if (token.position === "end") {
          ...
          options.parse = function (placeHolderContent) {
            return moduleParse(placeHolderContent, modules, startOffset, endLindex, options);
          };
...
var currentModuleApiVersion = [3, 17, 0];
