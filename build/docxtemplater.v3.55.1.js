  ...
  return _createClass(Docxtemplater, [{
    ...
    value: function updateFileTypeConfig() {
      ...
      for (var _i16 = 0, _this$modules8 = this.modules; _i16 < _this$modules8.length; _i16++) {
        ...
        for (var _i18 = 0, _ref4 = _module5.xmlContentTypes || []; _i18 < _ref4.length; _i18++) {
          var contentType = _ref4[_i18];
    ...
    value: function render(data) {
      ...
      for (var _i20 = 0; _i20 < output.length; _i20++) {
        var outputPart = output[_i20];
        var _outputPart = _slicedToArray(outputPart, 3),
          content = _outputPart[1],
          _currentFile = _outputPart[2];
        for (var _i22 = 0, _this$modules10 = this.modules; _i22 < _this$modules10.length; _i22++) {
          var _module6 = _this$modules10[_i22];
          if (_module6.preZip) {
            var result = _module6.preZip(content, _currentFile);
      ...
      for (var _i24 = 0; _i24 < output.length; _i24++) {
        var _output$_i = _slicedToArray(output[_i24], 2),
          _to = _output$_i[0],
    ...
    value: function createTemplateClassFromContent(content, filePath) {
      ...
      for (var _i26 = 0; _i26 < defaultKeys.length; _i26++) {
        var key = defaultKeys[_i26];
