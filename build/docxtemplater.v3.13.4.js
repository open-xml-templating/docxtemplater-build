    ...
    value: function render(part, options) {
      ...
      function loopOver(scope, i) {
        ...
        if (scope === true) {
          ...
          scopeManager = options.scopeManager.createSubScopeManager(scope, part.value, i, part);
        }
  ...
  _createClass(ScopeManager, [{
    ...
    value: function loopOverValue(value, functor, inverted) {
      ...
      if (this.isValueFalsy(value, type)) {
        return this.functorIfInverted(inverted, functor, this.scopeList[this.scopeList.length - 1], 0);
      }
...
},{"./errors":3}],20:[function(require,module,exports){
"use strict";
...
},{"./doc-utils":2}],22:[function(require,module,exports){
"use strict";
...
},{"./doc-utils":2,"./errors":3,"./lexer":5,"./parser.js":14,"./postrender.js":15,"./render.js":17,"./resolve.js":18,"./scope-manager":19,"./xml-matcher":21}],"/src/js/docxtemplater.js":[function(require,module,exports){
"use strict";
...
var currentModuleApiVersion = [3, 12, 0];
...
},{"./doc-utils":2,"./errors":3,"./file-type-config":4,"./lexer":5,"./module-wrapper":7,"./modules/common":8,"./traits":20,"./xml-matcher":21,"./xml-templater":22}]},{},[])("/src/js/docxtemplater.js")
});
