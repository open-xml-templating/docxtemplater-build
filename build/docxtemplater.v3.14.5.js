...
var _require = require("../doc-utils"),
    ...
    getNearestLeftWithCache = _require.getNearestLeftWithCache,
    getNearestRightWithCache = _require.getNearestRightWithCache,
    buildNearestCache = _require.buildNearestCache;
...
var expandPairTrait = {
  ...
  postparse: function postparse(postparsed, _ref) {
    ...
    var innerParts;
    var cachedTags = buildNearestCache(postparsed, ["w:p", "w:tc"]);
    var newParsed = postparsed.reduce(function (newParsed, part, i) {
      ...
      var before = getNearestLeftWithCache(left - 1, cachedTags);
      var after = getNearestRightWithCache(right + 1, cachedTags);
...
var currentModuleApiVersion = [3, 13, 0];
