...
},{"./browser-versions/xmldom.js":1,"./errors":3,"./utils":21}],3:[function(require,module,exports){
"use strict";
...
var PptXFileTypeConfig = {
  ...
  tagsXmlLexedArray: ["p:sp", "a:tc", "a:tr", "a:table", "a:p", "a:r", "a:rPr", "p:txBody"],
  expandTags: [{
    contains: "a:tc",
    expand: "a:tr"
  }],
...
var DocXFileTypeConfig = {
  ...
  tagsXmlLexedArray: ["w:tc", "w:tr", "w:table", "w:p", "w:r", "w:br", "w:rPr", "w:pPr", "w:spacing"],
  expandTags: [{
    contains: "w:tc",
    expand: "w:tr"
  }],
...
},{"../module-wrapper":7}],9:[function(require,module,exports){
"use strict";
...
},{"../doc-utils":2,"../errors":3,"../mergesort":6,"../module-wrapper":7,"../traits":20}],10:[function(require,module,exports){
"use strict";
...
},{"../doc-utils":2,"../module-wrapper":7,"../prefix-matcher":16}],11:[function(require,module,exports){
"use strict";
...
},{"../doc-utils":2,"../errors":3,"../module-wrapper":7,"../prefix-matcher":16,"../traits":20}],12:[function(require,module,exports){
"use strict";
...
},{"../doc-utils":2,"../errors":3,"../module-wrapper":7}],13:[function(require,module,exports){
"use strict";
...
},{"../doc-utils":2,"../module-wrapper":7}],14:[function(require,module,exports){
"use strict";
...
function postrender(parts, options) {
  ...
  return parts.reduce(function (full, part) {
    for (var _i = 0, len = contains.length; _i < len; _i++) {
      var _contains$_i = contains[_i],
          tag = _contains$_i.tag,
          shouldContain = _contains$_i.shouldContain,
          value = _contains$_i.value;

      if (currentlyCollecting === _i) {
        if (part === "</".concat(tag, ">")) {
        ...
        if (part.trim().indexOf("<".concat(shouldContain)) !== -1) {
          currentlyCollecting = -1;
      ...
      if (currentlyCollecting === -1 && part.indexOf("<".concat(tag)) === 0) {
        currentlyCollecting = _i;
        collecting = part;
        return full;
      }
    }
...
},{"./doc-utils":2,"./errors":3}],18:[function(require,module,exports){
"use strict";
...
},{"./errors":3,"./utils":21}],20:[function(require,module,exports){
"use strict";
...
},{"./doc-utils":2,"./errors":3}],21:[function(require,module,exports){
"use strict";
...
},{"./doc-utils":2}],23:[function(require,module,exports){
"use strict";
...
},{"./doc-utils":2,"./errors":3,"./lexer":5,"./parser.js":14,"./postrender.js":15,"./render.js":17,"./resolve.js":18,"./scope-manager":19,"./xml-matcher":22}],"/src/js/docxtemplater.js":[function(require,module,exports){
"use strict";
...
var currentModuleApiVersion = [3, 14, 0];
...
},{"./doc-utils":2,"./errors":3,"./file-type-config":4,"./lexer":5,"./module-wrapper":7,"./modules/common":8,"./traits":20,"./xml-matcher":22,"./xml-templater":23}]},{},[])("/src/js/docxtemplater.js")
});
