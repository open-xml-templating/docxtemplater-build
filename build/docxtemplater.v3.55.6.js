...
},{"./errors.js":5,"./utils.js":26,"@xmldom/xmldom":35}],4:[function(require,module,exports){
"use strict";
...
},{"./utils.js":26}],6:[function(require,module,exports){
"use strict";
...
},{"./modules/expand-pair-trait.js":14,"./modules/loop.js":15,"./modules/rawxml.js":16,"./modules/render.js":17,"./modules/space-preserve.js":18}],7:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":3,"./filetypes.js":7}],10:[function(require,module,exports){
"use strict";
...
function parseDelimiters(innerContentParts, delimiters, syntaxOptions) {
  ...
  var parsed = ranges.map(function (p, i) {
    ...
    for (var _i3 = 0; _i3 < delimitersInOffset.length; _i3++) {
      var delimiterInOffset = delimitersInOffset[_i3];
...
function decodeContentParts(xmlparsed, fileType) {
  var inTextTag = false;
  for (var _i5 = 0; _i5 < xmlparsed.length; _i5++) {
    var part = xmlparsed[_i5];
...
module.exports = {
  ...
  parse: function parse(xmllexed, delimiters, syntax, fileType) {
    ...
    var index = 0;
    var lIndex = 0;
    for (var _i7 = 0; _i7 < xmllexed.length; _i7++) {
      var part = xmllexed[_i7];
      if (isInsideContent(part)) {
        for (var _i9 = 0, _delimiterParsed$inde2 = delimiterParsed[index]; _i9 < _delimiterParsed$inde2.length; _i9++) {
          var p = _delimiterParsed$inde2[_i9];
          if (p.type === "content") {
...
},{"./doc-utils.js":3,"./errors.js":5}],11:[function(require,module,exports){
"use strict";
...
},{"./errors.js":5}],13:[function(require,module,exports){
"use strict";
...
},{"../content-types.js":2,"../filetypes.js":7,"../module-wrapper.js":12}],14:[function(require,module,exports){
"use strict";
...
function getPairs(traits) {
  ...
  // Stryker restore all
  var countOpen = 0;
  for (var _i3 = 0; _i3 < traits.length; _i3++) {
    var currentTrait = traits[_i3];
...
},{"../doc-utils.js":3,"../errors.js":5,"../merge-sort.js":11,"../module-wrapper.js":12,"../traits.js":25}],15:[function(require,module,exports){
"use strict";
  ...
  return _createClass(LoopModule, [{
    ...
    value: function render(part, options) {
      ...
      function loopOver(scope, i, length) {
        ...
        for (var _i6 = 0, _part$subparsed2 = part.subparsed; _i6 < _part$subparsed2.length; _i6++) {
          var pp = _part$subparsed2[_i6];
        ...
        for (var _i7 = 0, len = subRendered.parts.length; _i7 < len; _i7++) {
          totalValue.push(subRendered.parts[_i7]);
        }
...
},{"../doc-utils.js":3,"../filetypes.js":7,"../module-wrapper.js":12}],16:[function(require,module,exports){
"use strict";
...
},{"../doc-utils.js":3,"../errors.js":5,"../module-wrapper.js":12,"../traits.js":25}],17:[function(require,module,exports){
"use strict";
...
},{"../content-types.js":2,"../doc-utils.js":3,"../errors.js":5,"../module-wrapper.js":12}],18:[function(require,module,exports){
"use strict";
...
},{"../doc-utils.js":3,"../module-wrapper.js":12}],19:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":3,"./prefix-matcher.js":21}],20:[function(require,module,exports){
"use strict";
...
function postrender(parts, options) {
  ...
  // Stryker disable all : because this is an optimisation that won't make any tests fail
  for (var _i3 = 0; _i3 < uintArrays.length; _i3++) {
    var buf = uintArrays[_i3];
    for (var _i4 = 0; _i4 < buf.length; ++_i4) {
      array[_i4 + j] = buf[_i4];
    }
    j += buf.length;
  } // Stryker restore all
...
},{"./doc-utils.js":3,"./errors.js":5,"./get-resolved-id.js":8}],23:[function(require,module,exports){
"use strict";
...
},{"./get-resolved-id.js":8}],24:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":3,"./errors.js":5,"./utils.js":26}],25:[function(require,module,exports){
"use strict";
...
function expandToOne(postparsed, options) {
  ...
  var maxRight = -1;
  var offset = 0;
  for (var _i = 0, _len = limits.length; _i < _len; _i++) {
    var _postparsed;
    var _limit2 = limits[_i];
    maxRight = Math.max(maxRight, _i > 0 ? limits[_i - 1].right : 0);
...
},{"./doc-utils.js":3,"./errors.js":5}],26:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":3}],28:[function(require,module,exports){
"use strict";
...
},{"./doc-utils.js":3,"./join-uncorrupt.js":9,"./lexer.js":10,"./parser.js":19,"./postrender.js":20,"./render.js":22,"./resolve.js":23,"./xml-matcher.js":27}],29:[function(require,module,exports){
'use strict';
...
},{"./conventions":29,"./dom":31,"./entities":32,"./errors":33,"./sax":36}],31:[function(require,module,exports){
'use strict';
...
},{"./conventions":29,"./errors":33,"./grammar":34}],32:[function(require,module,exports){
'use strict';
...
},{"./conventions":29}],33:[function(require,module,exports){
'use strict';
...
},{"./conventions":29}],34:[function(require,module,exports){
'use strict';
...
},{"./conventions":29,"./dom":31,"./dom-parser":30,"./errors":33}],36:[function(require,module,exports){
'use strict';
...
},{"./conventions":29,"./errors":33,"./grammar":34}],"/src/js/docxtemplater.js":[function(require,module,exports){
"use strict";
...
var Docxtemplater = /*#__PURE__*/function () {
  ...
  return _createClass(Docxtemplater, [{
    ...
    value: function updateFileTypeConfig() {
      ...
      for (var _i16 = 0, _this$modules8 = this.modules; _i16 < _this$modules8.length; _i16++) {
        var _module5 = _this$modules8[_i16];
      ...
      for (var _i18 = 0, _this$modules10 = this.modules; _i18 < _this$modules10.length; _i18++) {
        var _module6 = _this$modules10[_i18];
        for (var _i20 = 0, _ref4 = _module6.xmlContentTypes || []; _i20 < _ref4.length; _i20++) {
          var contentType = _ref4[_i20];
    ...
    value: function render(data) {
      ...
      for (var _i22 = 0; _i22 < output.length; _i22++) {
        var outputPart = output[_i22];
        var _outputPart = _slicedToArray(outputPart, 3),
          content = _outputPart[1],
          _currentFile = _outputPart[2];
        for (var _i24 = 0, _this$modules12 = this.modules; _i24 < _this$modules12.length; _i24++) {
          var _module7 = _this$modules12[_i24];
          if (_module7.preZip) {
      ...
      for (var _i26 = 0; _i26 < output.length; _i26++) {
        var _output$_i = _slicedToArray(output[_i26], 2),
          _to = _output$_i[0],
    ...
    value: function createTemplateClassFromContent(content, filePath) {
      ...
      for (var _i28 = 0; _i28 < defaultKeys.length; _i28++) {
        var key = defaultKeys[_i28];
...
},{"./collect-content-types.js":1,"./doc-utils.js":3,"./error-logger.js":4,"./errors.js":5,"./file-type-config.js":6,"./lexer.js":10,"./module-wrapper.js":12,"./modules/common.js":13,"./scope-manager.js":24,"./traits.js":25,"./xml-matcher.js":27,"./xml-templater.js":28}]},{},[])("/src/js/docxtemplater.js")
});
